...
const services = [
  { id: '1', name: 'Image Recognition', price: 1, description: 'Identify objects in images using AI.' },
  { id: '2', name: 'Text Summarization', price: 1, description: 'Generate concise summaries from text.' },
  { id: '3', name: 'Voice Generation', price: 1, description: 'Convert text to human-like speech.' }
];
