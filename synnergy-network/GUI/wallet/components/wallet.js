document.getElementById("createBtn").addEventListener("click", async () => {
  ...
  document.getElementById("createOutput").textContent = JSON.stringify(
    data,
    null,
    2,
  );
...
document.getElementById("importBtn").addEventListener("click", async () => {
  ...
  const data = await res.json();
  document.getElementById("importOutput").textContent = JSON.stringify(
    data,
    null,
    2,
  );
...
document.getElementById("addressBtn").addEventListener("click", async () => {
  ...
  const data = await res.json();
  document.getElementById("addressOutput").textContent = JSON.stringify(
    data,
    null,
    2,
  );
...
document.getElementById("signBtn").addEventListener("click", async () => {
  ...
  const data = await res.json();
  document.getElementById("signOutput").textContent = JSON.stringify(
    data,
    null,
    2,
  );
...
document.getElementById("opcodesBtn").addEventListener("click", async () => {
  ...
  const data = await res.json();
  document.getElementById("opcodesOutput").textContent = JSON.stringify(
    data,
    null,
    2,
  );
