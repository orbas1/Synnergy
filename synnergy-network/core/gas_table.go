...
/*
   ...
   DebtToken_Issue: 2_100,
   DebtToken_Payment: 2_100,
   DebtToken_AdjustInterest: 800,
   DebtToken_MarkDefault: 500,
   DebtToken_History: 400,
...
var gasNames = map[string]uint64{
	...
	"DebtToken_Issue":          0,
	"DebtToken_Payment":        0,
	"DebtToken_AdjustInterest": 0,
	"DebtToken_MarkDefault":    0,
	"DebtToken_History":        0,
