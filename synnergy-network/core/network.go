...
// Types and interfaces for the networking stack are defined in
// `common_structs.go`. This file focuses on the runtime logic and methods that
// operate on those shared structures.
