...
// Core networking types (NodeID, Peer, Message, Config, Node, NetworkMessage,
// NATManager, and Block) are defined in other files within this package to
// avoid duplicate declarations. This file focuses purely on networking logic
