...
// Types such as NodeID, Peer, Message, Config, NetworkMessage, Block,
// NATManager, and Node are defined in other files within this package to
// avoid duplication. This file focuses on the networking logic built around
// those shared structures.
