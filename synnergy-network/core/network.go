...
// NOTE: Core networking types such as NodeID, Peer, Message, Config,
// NetworkMessage, Block, and NATManager are defined in other files
// (e.g. common_structs.go and nat_traversal.go). Duplicate definitions
// previously existed in this file, causing redeclaration errors during
// compilation. Those duplicates have been removed so this file focuses
// solely on networking logic and helpers.
