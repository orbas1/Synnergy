...
// Note: core/common_structs.go defines NodeID, Peer, Message, Config,
// NetworkMessage, Block, NATManager and parsePort. This file adds the
// networking logic and associated helpers.
